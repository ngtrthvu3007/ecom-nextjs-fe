const ButtonGroup = () => {
  return (
    <div className="mt-4">
      ...
      <div className="flex sm:block col-span-2 mt-2">
        <button className="w-full text-center border-blue-600 border-2 text-blue-600 rounded-md py-4 font-bold text-[20px] mr-6 sm:mb-2">
          Trả góp 0%
        </button>
