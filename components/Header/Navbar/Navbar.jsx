...
import { totalProductInCart } from "../../../app/cart/useCart";
...
export default function NavigationBar() {
  ...
  const productInCart = totalProductInCart(profile?._id ?? null);
                  ...
                  <div className="text-[18px] ml-2 ">
                    <Dropdown text={profile?.name} className="font-semibold">
                      <Dropdown.Menu className="cursor-pointer">
                        <Dropdown.Item text="Tài khoản" icon="user" href="/user" />
                        {profile?.isAdmin && <Dropdown.Item text="Quản lý" icon="dashboard" />}
                        <Dropdown.Item
                          text="Đăng xuất"
                          icon="sign-out"
